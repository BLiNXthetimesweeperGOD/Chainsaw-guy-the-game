...
class Collectible(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("backgrounds/Tree.png")
        self.rect = self.image.get_rect()
        self.rect.center = (2500, 300)

class Collectible2(pygame.sprite.Sprite): #Level 2 tree
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("backgrounds/Tree 2.png")
        self.rect = self.image.get_rect()
        self.rect.center = (2500, 300)
