...
class Collectible(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        trees = ["backgrounds/Tree.png",
                 "backgrounds/Tree 2.png",
                 "backgrounds/Tree 3.png",
                 "backgrounds/Tree 4.png"]
                 
        self.image = pygame.image.load(random.choice(trees))
...
def Level5():
    ...
    score = 40
    items = 0
    background_image = pygame.image.load("backgrounds/Background5.JPG")
    ...
    current = base_pos
    pygame.mixer.music.load("Music/EndGameplay.wav")
